    ...
    <Section>
      <Div>
        ...
        <Text>
          ...
          elektricien beschikbaar hebben bij u in de regio.<br></br>
          <br></br>
          ...
          <br></br>
          <br></br>Dus, heeft u last van een storing, wilt u elektra laten
          aanleggen of renoveren? Aarzel dan niet en neem contact met ons op. In
          de meeste gevallen is er direct een elektricien beschikbaar om u te
          helpen
        </Text>
        <Button style={{ marginTop: " 30px" }}>
          <PhoneIcon></PhoneIcon>+44 333 222 1111
        </Button>
      </Div>
    </Section>
  );
